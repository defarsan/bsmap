...
//    console.log('emptify ' + this.options.save_id);
  ...
  const data = storageGet(this.options.save_id);
  ...
  storageSet(this.options.save_id, this.saveToObject());
  return this;
},
      ...
      for (i = 0; i < this.objects.length; i++) {
        ...
        if (this.deleted[i]) {
          ...
          L.DomEvent.addListener(line, 'mouseover', (function(o, self){
            return function() {
              App.cancelExec('mouseout', o);
              App.delayExec('mouseover', function(){
          ...
          L.DomEvent.addListener(line, 'mouseout', (function(o, self){
            return function() {
              App.cancelExec('mouseover', o);
              App.delayExec('mouseout', function(){
                if (!this.hasOwnProperty('__mouseOverMe')) return;
